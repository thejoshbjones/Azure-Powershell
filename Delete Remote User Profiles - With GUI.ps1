...
#add computers to computers variable to search for profiles on those computers
	[array] $Computers = "TS01","TS02","TS03","TS04","TS05","TS06","TS07","TS08","TS09","TS10","TS11","TS12","TS13","TS14","TS15","TS16"
	$log = ".\DeleteProfilelog.txt"
	$date = Get-Date
...
Function SetupForm {
	...
	$CancelButton.Location = New-Object System.Drawing.Size(210,240)
...
#Rename Roaming Profile
move-item \\File01\AppServerProfiles\$selectedUser.HQ.V2 \\File01\AppServerProfiles\$selectedUser.HQ.V2.old
